class PerlXmlParser < Formula
  ...
  # if homebrew perl is not installed, use system perl
  uses_from_macos "perl" unless Formula["perl"].any_version_installed?
  ...
  test do
    ENV.prepend_create_path "PERL5LIB", libexec/"lib/perl5" if OS.linux? && !!Formula["perl"].any_version_installed?
